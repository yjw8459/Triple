...
<%
    ...
    List<String> yPos = new ArrayList<>();
    xPos.add("37.56017376037095");
    xPos.add("35.18902828940665");
    xPos.add("33.369137312966245");
    xPos.add("37.38439082333994");
    xPos.add("36.3508016342678");
    xPos.add("35.87940079347053");
    xPos.add("35.179245325940364");
    xPos.add("35.56348080588944");
    xPos.add("36.61876971456634");
    xPos.add("37.38402980655906");
    xPos.add("37.700788242697215");
    xPos.add("36.80963406146809");
    xPos.add("36.19453874586802");
    xPos.add("36.40506048833501");
    xPos.add("35.47391644486985");
    xPos.add("35.69575171271861");
    xPos.add("34.84704283758656");

    yPos.add("126.97330071852909");
    yPos.add("129.08765343709558");
    yPos.add("126.53451726408638");
    yPos.add("126.66117418782147");
    yPos.add("127.38440166373996");
    yPos.add("128.5954141459484");
    yPos.add("126.85044245925249");
    yPos.add("129.3005893030789");
    yPos.add("127.24836183454035");
    yPos.add("127.44742536714901");
    yPos.add("128.28532700666773");
    yPos.add("127.86864817627433");
    yPos.add("127.01931250520786");
    yPos.add("128.6175104181268");
    yPos.add("128.5535181817519");
    yPos.add("127.32466422181973");
    yPos.add("126.95181380093044");
%>
...
<body>
<form action="Map_Practice.jsp" id="map_form">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#plan_make').click(function () {
                Test(<%=xPos.get(0)%>, <%=yPos.get(0)%>);
